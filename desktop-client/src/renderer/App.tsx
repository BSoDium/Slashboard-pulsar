...
import ServerStats from 'renderer/components/ServerStats';
        ...
        <Switch>
          ...
          <Route path="/dashboard/servers">
            <Window>
              <Dashboard
                child={
                  <ControlPanel offline={{
                    value: offlineMode,
                    setter: (value: boolean) => { this.setState({ offlineMode: value }) }
                  }} />
                }
              />
            </Window>
